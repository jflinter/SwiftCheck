...
func terms(_ s : Sig, _ r : ExprTypeRel) -> ExprTypeRel {
	return termsSatisfying({ _ in true }, s, r)
}

func termsSatisfying(_ p : (Term) -> Bool, _ sig : Sig, _ base : ExprTypeRel) -> ExprTypeRel {
